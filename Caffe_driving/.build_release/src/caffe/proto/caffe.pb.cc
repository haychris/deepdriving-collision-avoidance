...
void protobuf_AssignDesc_caffe_2eproto() {
  ...
  static const int SolverParameter_offsets_[35] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SolverParameter, slave_device_id_),
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SolverParameter, debug_display_),
...
void protobuf_AddDesc_caffe_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "SolverMode:\003GPU\022\024\n\tdevice_id\030\022 \001(\005:\0010\022\033\n"
    "\017slave_device_id\030\" \001(\005:\002-1\022\027\n\013random_see"
    "d\030\024 \001(\003:\002-1\022\032\n\017update_interval\030! \001(\005:\0011\022"
    ";\n\013solver_type\030\036 \001(\0162!.caffe.SolverParam"
    "eter.SolverType:\003SGD\022\024\n\005delta\030\037 \001(\002:\0051e-"
    "08\022\031\n\ndebug_info\030\027 \001(\010:\005false\022\025\n\rdebug_d"
    "isplay\030( \001(\005\022\"\n\024snapshot_after_train\030\034 \001"
    ...
    " \001(\0162\037.caffe.LayerParameter.LayerType\022\037\n"
    "\005blobs\030\006 \003(\0132\020.caffe.BlobProto\022\016\n\005param\030"
    "\351\007 \003(\t\022<\n\017blob_share_mode\030\352\007 \003(\0162\".caffe"
    ".LayerParameter.DimCheckMode\022\020\n\010blobs_lr"
    "\030\007 \003(\002\022\024\n\014weight_decay\030\010 \003(\002\022\023\n\013loss_wei"
    "ght\030# \003(\002\0220\n\016accuracy_param\030\033 \001(\0132\030.caff"
    "e.AccuracyParameter\022,\n\014argmax_param\030\027 \001("
    "\0132\026.caffe.ArgMaxParameter\022,\n\014concat_para"
    "m\030\t \001(\0132\026.caffe.ConcatParameter\022\?\n\026contr"
    "astive_loss_param\030( \001(\0132\037.caffe.Contrast"
    ...
    "er\0223\n\020dummy_data_param\030\032 \001(\0132\031.caffe.Dum"
    "myDataParameter\022.\n\reltwise_param\030\030 \001(\0132\027"
    ".caffe.EltwiseParameter\0221\n\017hdf5_data_par"
    "am\030\r \001(\0132\030.caffe.HDF5DataParameter\0225\n\021hd"
    "f5_output_param\030\016 \001(\0132\032.caffe.HDF5Output"
    "Parameter\0223\n\020hinge_loss_param\030\035 \001(\0132\031.ca"
    "ffe.HingeLossParameter\0223\n\020image_data_par"
    "am\030\017 \001(\0132\031.caffe.ImageDataParameter\0229\n\023i"
    "nfogain_loss_param\030\020 \001(\0132\034.caffe.Infogai"
    "nLossParameter\0229\n\023inner_product_param\030\021 "
    "\001(\0132\034.caffe.InnerProductParameter\022&\n\tlrn"
    "_param\030\022 \001(\0132\023.caffe.LRNParameter\0225\n\021mem"
    "ory_data_param\030\026 \001(\0132\032.caffe.MemoryDataP"
    "arameter\022&\n\tmvn_param\030\" \001(\0132\023.caffe.MVNP"
    ...
    "\n\013slice_param\030\037 \001(\0132\025.caffe.SliceParamet"
    "er\022(\n\ntanh_param\030% \001(\0132\024.caffe.TanHParam"
    "eter\0222\n\017threshold_param\030\031 \001(\0132\031.caffe.Th"
    "resholdParameter\0225\n\021window_data_param\030\024 "
    "\001(\0132\032.caffe.WindowDataParameter\0227\n\017trans"
    "form_param\030$ \001(\0132\036.caffe.TransformationP"
    ...
    "_PRODUCT\020\016\022\007\n\003LRN\020\017\022\017\n\013MEMORY_DATA\020\035\022\035\n\031"
    "MULTINOMIAL_LOGISTIC_LOSS\020\020\022\007\n\003MVN\020\"\022\013\n\007"
    ...
    "s\030\002 \001(\010:\005false\"\203\003\n\020PoolingParameter\0225\n\004p"
    ...
    "oolingParameter.Engine:\007DEFAULT\".\n\nPoolM"
    ...
    "Engine:\007DEFAULT\"+\n\006Engine\022\013\n\007DEFAULT\020\000\022\t"
    "\n\005CAFFE\020\001\022\t\n\005CUDNN\020\002\"x\n\020SigmoidParameter"
    "\0227\n\006engine\030\001 \001(\0162\036.caffe.SigmoidParamete"
    "r.Engine:\007DEFAULT\"+\n\006Engine\022\013\n\007DEFAULT\020\000"
    "\022\t\n\005CAFFE\020\001\022\t\n\005CUDNN\020\002\";\n\016SliceParameter"
    ...
    "\"+\n\006Engine\022\013\n\007DEFAULT\020\000\022\t\n\005CAFFE\020\001\022\t\n\005CU"
    "DNN\020\002\"r\n\rTanHParameter\0224\n\006engine\030\001 \001(\0162\033"
    ".caffe.TanHParameter.Engine:\007DEFAULT\"+\n\006"
    "Engine\022\013\n\007DEFAULT\020\000\022\t\n\005CAFFE\020\001\022\t\n\005CUDNN\020"
...
const int SolverParameter::kSlaveDeviceIdFieldNumber;
...
const int SolverParameter::kDebugDisplayFieldNumber;
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 33: {
        ...
        if (input->ExpectTag(272)) goto parse_slave_device_id;
        break;
      }

      // optional int32 slave_device_id = 34 [default = -1];
      case 34: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_slave_device_id:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 input, &slave_device_id_)));
          set_has_slave_device_id();
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectTag(320)) goto parse_debug_display;
        break;
      }
...
void SolverParameter::SerializeWithCachedSizes(
  ...
  // optional int32 slave_device_id = 34 [default = -1];
  if (has_slave_device_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(34, this->slave_device_id(), output);
  }

  // optional int32 debug_display = 40;
  if (has_debug_display()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(40, this->debug_display(), output);
  }
...
::google::protobuf::uint8* SolverParameter::SerializeWithCachedSizesToArray(
  ...
  // optional int32 slave_device_id = 34 [default = -1];
  if (has_slave_device_id()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(34, this->slave_device_id(), target);
  }

  // optional int32 debug_display = 40;
  if (has_debug_display()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(40, this->debug_display(), target);
  }
...
void SolverParameter::MergeFrom(const SolverParameter& from) {
  ...
  if (from._has_bits_[24 / 32] & (0xffu << (24 % 32))) {
    ...
    if (from.has_slave_device_id()) {
      set_slave_device_id(from.slave_device_id());
    }
...
void SolverParameter::Swap(SolverParameter* other) {
  if (other != this) {
    ...
    std::swap(slave_device_id_, other->slave_device_id_);
